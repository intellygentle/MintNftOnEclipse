...
function getResizeInstructionDataSerializer() {
    return (0, serializers_1.mapSerializer)((0, serializers_1.struct)([
        ...
        ['strategy', (0, types_1.getStrategySerializer)()],
    ], { description: 'ResizeInstructionData' }), (value) => ({ ...value, discriminator: 17 }));
}
...
function resize(context, input) {
    ...
    // Data.
    const data = getResizeInstructionDataSerializer().serialize(resolvedArgs);
