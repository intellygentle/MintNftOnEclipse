...
exports.revoke = exports.getRevokeInstructionDataSerializer = void 0;
const umi_1 = require("@metaplex-foundation/umi");
const serializers_1 = require("@metaplex-foundation/umi/serializers");
const shared_1 = require("../shared");
const types_1 = require("../types");
function getRevokeInstructionDataSerializer() {
    return (0, serializers_1.mapSerializer)((0, serializers_1.struct)([
        ['discriminator', (0, serializers_1.u8)()],
        ['delegateInput', (0, types_1.getDelegateInputSerializer)()],
    ], { description: 'RevokeInstructionData' }), (value) => ({ ...value, discriminator: 6 }));
}
